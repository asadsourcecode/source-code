    ...
    <div class="audio-stories-bg min-h-screen">
        ...
        <div class="flex justify-center mt-8 sm:mt-10">
            <div class="w-11/12 md:w-10/12 lg:w-8/12">
                ...
                <p class="oc-body-text font-light text-[13px] sm:text-[15px] md:text-[17px] lg:text-[20px]" style="color: black;">
                ...
                <p class="oc-body-text text-[13px] sm:text-[15px] md:text-[17px] lg:text-[20px]"><em>(Andersen N.V (2021) Kunsten at tale so alle lytter. En praktisk og videnskabelig funderet guide til storytelling. [The art of talking in a way that everybody listens. A practical and scientifically based guide to storytelling.] Frydenlund. Denmark. P.24-27)</em></p>
        ...
        <div class="flex justify-center mt-5 mb-[40px] sm:mb-[60px] lg:mb-[100px]">
            <img src="{{ asset('images/headphone.webp') }}" alt="Headphone" class="w-[80%] sm:w-[60%] md:w-[50%] lg:w-auto max-w-full h-auto">
        </div>
