...
class EbooksService
{
    ...
    public function getData(): array
    {
        ...
        $catalogButtonUrl  = $page?->meta('catalog_button_url', self::DEFAULTS['catalog_button_url'])  ?? self::DEFAULTS['catalog_button_url'];
        ...
        return compact('page', 'recommendHeading', 'bulletItems', 'catalogButtonText', 'catalogButtonUrl', 'mainImage', 'boyImage');
    }
}
